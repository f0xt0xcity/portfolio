            ...
            <div className='text-center'>
              <div className='row'>
                <div className='col-6 col-sm-4'>
                  <Image src={'/img/certificadoCloud.png'} layout='responsive' width={ 480 } height={ 480 }/>
                </div>
                <div className='col-6 col-sm-4'>
                  <Image src={'/img/certificadoBussines.png'} layout='responsive' width={ 480 } height={ 480 }/>
                </div>
                <div className='col-6 col-sm-4'>
                  <Image src={'/img/certificadoMkt.png'} layout='responsive' width={ 480 } height={ 480 }/>
                </div>
              </div>
              <Link href={'https://drive.google.com/drive/folders/1ARwKxoeIQSiFX4KjuS07I073jRiqWBpO?usp=sharing'}>
                <a className='btn btn-primary mt-5  mb-5'>Ver todos los certificados</a>
              </Link>
            </div>
        </div>
